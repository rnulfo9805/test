...
public class TileManager {
	...
	public void getTileImage() {
		...
		try {
			...
			tile[3] = new Tile();
			tile[3].image = ImageIO.read(getClass().getResourceAsStream("/tiles/Computer_Desk_1.png"));
			
			tile[4] = new Tile();
			tile[4].image = ImageIO.read(getClass().getResourceAsStream("/tiles/Wooden_Floor.png"));
